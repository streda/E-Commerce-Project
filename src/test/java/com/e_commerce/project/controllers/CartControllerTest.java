...
// public void setup() {
// validToken = "token123";
// // stub out JWTUtil so that only tests with the right token pass
// Mockito.when(jwtUtil.generateToken("testuser")).thenReturn(validToken);
// Mockito.when(jwtUtil.validateToken(validToken)).thenReturn(true);
// Mockito.when(jwtUtil.getUsernameFromToken(validToken)).thenReturn("testuser");
// }

// @Test
// public void addToCart_requiresAuth() throws Exception {
// String body = """
// {
// "username":"testuser",
// "itemId":1,
...
// @Test
// public void addToCart_withValidToken() throws Exception {
// String body = """
// {
// "username":"testuser",
// "itemId":1,
